...
2. Save the retrieved source snapshot locally before transforming it.
...
Raw or source-shaped Setlist Index data belongs under data/karaoke/raw/setlist-index/. Normalized data belongs under data/karaoke/normalized/. Do not overwrite a previous source snapshot; preserve retrieval date and source URL.
